...
const FirstParagraph = () => {
  return (
    <div className="relative ">
      <img
        src={imageAssets.aboutFirst1}
        alt=""
        className="absolute top-[-15%] left-[25%] z-0 block"
      />

      <img
        src={imageAssets.aboutFirst2}
        alt=""
      ...
      <div className="bg-backgroundClr flex flex-col items-center justify-center px-4 sm:px-6">
        ...
        <p className="font-body text-19 text-center text-textDisableClr max-w-[750px] font-5 mt-4 mb-10">
          Smart gateway collects machine data in real time, enabling predictive
          maintenance and better OEE to reduce downtime.
        </p>
      </div>
    </div>
  );
